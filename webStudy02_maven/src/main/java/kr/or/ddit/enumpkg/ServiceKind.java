...
public enum ServiceKind {
	GUGUDAN(MenuVO.getBuilder().menuText("구구단").menuPath("/html/02/gugudan.jsp").build()),
	LOCALEMESSAGE(MenuVO.getBuilder().menuText("로케일메세지").menuPath("/html/02/messageLocale.jsp").build()),
