...
public class SearchZipDAOImpl_JDBC_NonPaging{
	private SearchZipDAOImpl_JDBC_NonPaging() { }
	private static SearchZipDAOImpl_JDBC_NonPaging self;
	public static SearchZipDAOImpl_JDBC_NonPaging getInstance() {
		if(self==null) self = new SearchZipDAOImpl_JDBC_NonPaging();
		return self;
	}
