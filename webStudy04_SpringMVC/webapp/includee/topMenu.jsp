  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="${pageContext.request.contextPath }/book/guestBook.do" tabindex="-1" aria-disabled="true">방명록</a>
        </li>
        <li class="nav-item">
          <a class="nav-link timeArea" href="#" tabindex="-1" aria-disabled="true"></a>
		</li>
		<li>
	      <input type="image" src="${pageContext.request.contextPath }/images/korean.jpg" class="flag" id="KO" onclick="location.href='?lang=ko'" /> 
		  <input type="image" src="${pageContext.request.contextPath }/images/us.png" class="flag" id="EN" onclick="location.href='?lang=en'" />
		</li>
      </ul>
      <form class="d-flex">
