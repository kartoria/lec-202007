...
<body>
<pre>
	: Http의 stateless의 단점을 보완하기 위해 최소한의 상태정보를 저장하는 개념.
...
<% 
//	1. 쿠키생성
	Cookie ck = new Cookie("sample", "sampleValue");
	
//	2. response에 쿠키를 실어 전송 (header-문자 형태로 전송)
...
%>	
	...
	4. domain/host(optional) : 쿠키의 재전송 여부 결정에 사용. 생략시 쿠키 생성 도메인 반영.
		domain level 구조
		3 level : www.naver.com   (Global Top Level Domain)
		4 level : www.naver.co.kr (National Top Level Domain)
...
// 		allDomainCookie.setDomain("www.ksj.com"); //dummyVersion7에서 테스트
