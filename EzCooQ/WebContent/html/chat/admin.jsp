...
<body>
	...
	<div class="template" style="display: none">
		<div class="chatDiv2" style="text-align: center">
			<h2>회원과의 채팅!</h2>
			<!-- 서버와 메시지를 주고 받는 콘솔 텍스트 영역 -->
			<textarea id="messageTextArea" class="noresize" rows="10" cols="50" disabled="disabled"></textarea>
			<br />
			<form class="form">
				<!-- 메시지 텍스트 박스 -->
	...
	<script type="text/javascript">
		...
		var webSocket = new WebSocket("ws://localhost:9090/EzCooQ/admin");
