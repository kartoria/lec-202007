...
function BuyPage() {
	...
	<form action="/EzCooQ/InsertPayRecipe" method="post">
			...
			<div class="container">
				...
				<div class="row">
					...
					<tr>
						...
						<td>
							<input type="button" class="form-control"
								onclick="location.href='<%=request.getContextPath() %>/SelectPayBoardServlet'" value="돌아가기">
						</td>	
					</tr>
					<tr>
						<td>
						...
						<td colspan="2">
						<input type="text" class="form-control" id="inputTd" name="memId" value="admin" readonly="readonly">
						</td>
					...
					<tr>
						...
						<td colspan="2">
							<input type="text" class="form-control" id="inputTd" name = "recipeId" value="유료 레시피" readonly="readonly">
						</td>
					...
					<tr>
						...
						<td colspan="2">
							<input type="number" class="form-control" id="inputTd" name = "recipePay">
						</td>
					...
					<tr>
						...
						<td>
							...
							value="등록" onclick="location.href='<%=request.getContextPath() %>/SelectPayBoardServlet'" >
						</td>
						<td></td>
					</tr>
					</table>
