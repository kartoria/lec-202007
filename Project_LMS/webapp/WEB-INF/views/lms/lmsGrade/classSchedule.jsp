...
<div class="container-fluid border px-3" style="min-height:300px">
	<div class="row my-3">
		<div class="col-12 d-flex justify-content-start align-items-center">
			<h5 class="ml-2"><i class="fas fa-home"></i> 학점 및 성적 > 시간표</h5>
		</div>
	</div>
	...
	<div class="row mt-3 mb-5">
		<div class="col-12 d-flex justify-content-start align-items-center">
			<h5 class="ml-2">수강신청한 시간표입니다.</h5>
		</div>
	</div>
	<div id="pdfArea" class="container" style="width: 50%; height: 1000px;">
		<iframe id="iframId" src="${cPath}/enrolment/schedulePdf.do" style="width: 80%; height: 960px;" ></iframe>
	</div>
</div>
