...
<form:form commandName="board"
	action="${cPath}/cyber/qna/update.do" id="qnaForm" method="post">
	<!-- hidden 값들 -->
	...
	<div class="container-fluid">
		...
		<div class="row my-3 border-bottom border-cyber">
			<div class="col-12 d-flex justify-content-start align-items-center">
				<h2 class="font-weight-bold">질문글 수정</h2>
			</div>
		</div>
		<div class="row mt-3 mb-5">
			<div class="col-12 d-flex justify-content-start align-items-center">
				<h5 class="ml-2">Q&A 질문글을 수정할 수 있습니다.</h5>
			</div>
		</div>
					...
					<tr>
						...
						<td colspan="3">
							<div class="btn-group" data-toggle="buttons">
								<label class="publicLabel btn btn-light">
								 <form:radiobutton
										path="boSecret" class="custom-control-input" label="공개글"
										value="Y" id="boPublic" required="required"/> 
								 </label>
								 <label class="secretLabel btn btn-light">
								  <form:radiobutton
...
<script type="text/javascript">
	$(function() {
		if('${board.boSecret}' == 'N'){
			$(".secretLabel").addClass("active");
			
		}else{
			$(".publicLabel").addClass("active");
		}
	...
	$("#resetBtn").on("click", function(){
		location.href="${cPath}/cyber/qna/${board.memberVO.boNo}/view.do";
	});
</script>