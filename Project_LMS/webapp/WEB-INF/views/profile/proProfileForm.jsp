...
<div class="container-fluid border px-3" style="min-height:300px">
	...
	<form:form commandName="profileVO" id="updateForm" enctype="multipart/form-data">
		<div class="col-12">
			...
			<caption style="caption-side:top;"><span class="importantText">*</span> 필수 입력 </caption>
				<tbody id="listBody">
					<tr>
						<td rowspan="5" colspan="2" class="w-25">
							<img id="img" class="imgSize" src="${imagePath }"  style="width: 150px; height: 200px;" />
						</td>
					...
					<tr>
						...
						<td class="table-active" ><p class="font-weight-bold">직책</p></td>
						<td colspan="2">${profileVO.memPosition} <form:hidden path="memPosition" value="${profileVO.memPosition }"/></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="table-active">
							<p class="font-weight-bold">
								<form:label path="memTel" cssClass="required">전화번호	</form:label> 
							</p>
						</td>
						...
						<td class="table-active">
							<p class="font-weight-bold">
								<form:label path="memMail" cssClass="required">이메일</form:label> 
							</p>
						</td>
						<td colspan="2">
					...
					<tr>
						<td class="table-active" >
							<p class="font-weight-bold">
								<form:label path="memAddr1" cssClass="required">주소</form:label> 
							</p>
						</td>
						<td colspan="1">		
						...
						<td class="table-active" >
							<p class="font-weight-bold">
								<form:label path="memAddr2" cssClass="required">상세주소	</form:label> 
							</p>
						</td>
						<td colspan="2">
					...
					<tr>
						<td class="table-active" >
							<p class="font-weight-bold">
								<form:label path="memBank" cssClass="required">계좌</form:label> 
							</p>
						</td>
						...
						<td colspan="1">
						<form:hidden path="memBank"  class="form-control"  value="${profileVO.memBank }"/> 
						...
						<td class="table-active">
							<p class="font-weight-bold">
								<form:label path="memAcn" cssClass="required">계좌번호</form:label>
							 </p>
						 </td>
						<td colspan="2">
